      ...
      <section className="snap-section w-full min-h-[100dvh] flex flex-col justify-between items-center px-4 sm:px-8 pt-20 pb-8 sm:pb-12 relative overflow-hidden bg-transparent">
        ...
        <div className="relative flex flex-col items-center justify-center my-auto w-full max-w-full px-2 z-20 pt-10 sm:pt-0">
          ...
          <motion.div
            ...
            className="mt-6 sm:mt-10 flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto px-4 z-20"
          >
            <Button
              asChild
              className="h-11 sm:h-14 w-full sm:w-auto px-6 sm:px-10 rounded-full bg-[#ff8fab] hover:bg-white text-black font-mono font-bold text-xs sm:text-sm tracking-wider uppercase transition-all shadow-[0_0_30px_rgba(255,143,171,0.5)] active:scale-95"
            >
              <Link
            ...
            <Button
              asChild
              variant="outline"
              className="h-11 sm:h-14 w-full sm:w-auto px-6 sm:px-8 rounded-full border border-white/20 bg-black/40 hover:bg-white/10 text-white font-mono text-xs sm:text-sm tracking-wider uppercase backdrop-blur-xl"
            >
        ...
        <div className="flex flex-col items-center gap-1.5 opacity-50 z-20 pointer-events-none mt-6 sm:mt-0">
          ...
          <div className="w-[1px] h-6 sm:h-8 bg-gradient-to-b from-white to-transparent animate-pulse" />
        </div>
      </section>
